      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-2">
            ...
            <Badge
              variant={getPaymentStatusVariant(order.paymentStatus) as "default" | "secondary" | "destructive" | "outline"}
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Badge variant={getPaymentStatusVariant(order.paymentStatus) as "default" | "secondary" | "destructive" | "outline"} className="mt-2">
                    {order.paymentStatus}
                  </Badge>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="font-medium text-sm">
                    {formatPrice((Number(order.totalAmount) + Number(order.shippingCost) + Number(order.vatAmount)).toString())}
                  </p>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">{order.shipping.phoneNumber}</p>
                    <div className="text-sm mt-2 space-y-1">
                      <p>{order.shipping.streetAddress}</p>
                      {order.shipping.streetAddress2 && <p>{order.shipping.streetAddress2}</p>}
                      <p>{order.shipping.suburb}, {order.shipping.city}</p>
                      <p>{order.shipping.province} {order.shipping.postalCode}</p>
