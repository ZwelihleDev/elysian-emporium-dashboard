    ...
    >
      ...
      {isPending || !notifications ? (
        ...
        <Card className="p-12 text-center bg-background">
          <BellDotIcon className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
        ...
        <div className="space-y-3">
          {filtered?.map((n) => {
            ...
            return (
              <Card
                key={n.id}
                className={`transition-all duration-200 hover:shadow-md bg-background ${
                  !n.read ? "border-l-4 " : ""
                } ${isSelected ? "ring-2 " : ""}`}
              >
                <div className="p-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {n.image && (
                            <Image
                              ...
                              height={24}
                              unoptimized
                              className="h-24 w-24 object-contain rounded-md mt-2"
                            />
                          )}
