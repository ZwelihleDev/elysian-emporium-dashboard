...
export const adminSettingsSchema = z.object({
  siteName: z.string().min(1, "Site name is required").max(50, "Site name must be under 50 characters."),
  ...
  maintenanceMessage: z.string().max(300, "Maintenance message must be under 300 characters.").optional(),
