    ...
    <Form {...form}>
      <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <div className="flex space-x-4 items-end">
          ...
          >
            Generate Slug <SparklesIcon className="size-4 ml-1" />
          </Button>
        </div>
        ...
        <div className="flex space-x-4 items-end">
          ...
          >
            Generate SKU <SparklesIcon className="size-4 ml-1" />
          </Button>
        </div>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <UploadDropzone
                ...
                className="mt-4 ut-button:rounded-full ut-button:bg-ultramarine-700 ut-allowed-content:text-muted-foreground"
              />
              <FormMessage />
            </FormItem>
          )}
