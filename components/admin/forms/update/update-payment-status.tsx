...
import { updatePaymentStatusSchema, UpdatePaymentStatusSchemaType } from "@/schemas/admin/order";
...
const UpdatePaymentStatusForm = ({ orderId, currentPaymentStatus, onSuccess }: UpdatePaymentStatusFormProps) => {
