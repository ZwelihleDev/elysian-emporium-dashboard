...
export async function awardPoints(
  ...
  try {
    ...
    if (newMembership && (!updatedUser.membership || newMembership.minPoints > updatedUser.membership.minPoints)) {
    ...
    return {
      ...
      membershipUpgrade: newMembership && (!updatedUser.membership || newMembership.minPoints > updatedUser.membership.minPoints)
    };
  } catch (error) {
